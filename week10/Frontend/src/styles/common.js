...
export const articleHeader      = "mb-12 border-b border-[#e8e8ed] pb-10"
export const articleCategory    = "text-[0.7rem] font-bold text-[#0066cc] uppercase tracking-widest mb-3 block"
export const articleMainTitle   = "text-4xl md:text-5xl font-bold text-[#1d1d1f] tracking-tight mb-6 leading-tight"
export const articleAuthorRow   = "flex items-center justify-between text-sm text-[#6e6e73]"
export const authorInfo         = "font-medium text-[#1d1d1f]"
export const articleContent     = "text-[#1d1d1f] text-lg leading-relaxed mb-16 whitespace-pre-wrap"
export const articleFooter      = "border-t border-[#e8e8ed] pt-8 text-xs text-[#a1a1a6] mt-10"
export const articleActions     = "flex gap-4 mt-8"
export const editBtn           = "bg-white border border-[#d2d2d7] text-[#1d1d1f] font-medium px-4 py-1.5 rounded-full hover:bg-[#f5f5f7] transition-colors cursor-pointer text-xs"
export const deleteBtn         = "bg-white border border-[#ff3b30]/30 text-[#ff3b30] font-medium px-4 py-1.5 rounded-full hover:bg-[#ff3b30]/[0.05] transition-colors cursor-pointer text-xs"
